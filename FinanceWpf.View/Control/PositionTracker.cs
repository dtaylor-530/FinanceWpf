...
namespace FinanceWpf.View
{
    ...
    public class PositionTracker : Control
    {
        ...
        //public static readonly DependencyProperty StartProperty = DependencyProperty.Register("Start", typeof(double), typeof(PositionTracker3), new PropertyMetadata(100d, Changed));
        ...
        //    set { SetValue(PositionTrackerProperty, value); }
        //}
        ...
        //    DependencyProperty.Register("Prices_", typeof(IEnumerable), typeof(PositionTracker), new PropertyMetadata(null));
        ...
        public PositionTracker()
        {
            ...
            Style = resourceDictionary["PositionTracker"] as Style;
